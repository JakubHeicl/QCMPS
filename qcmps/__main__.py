...
from .circuit_blocks import Block, AUBlock, LUBlock
...
def parse_args():
    ...
    parser.add_argument("--block_type", type=str, default="AU", choices=["AU", "LU"], help="Type of block to use in the ansatz.")
